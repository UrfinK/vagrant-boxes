...
create temporary tablespace PHOENIX_TMP1 tempfile '/opt/oracle/oradata/ORCLCDB/P4DEV12CLIN/PHOENIX_TMP1.DBF' size 20m autoextend on next 10m maxsize unlimited;
